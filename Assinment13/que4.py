...
while True :
    ...
    match option:
        ...
        case 2:
             if unit<=100:
                bill=unit*5
                print("bill=unit*5=",bill)
             elif unit<=200:
                bill=100*5+(unit-100)*7
                print(f" Bill Amount :100*5={100*5+}100*7={(unit-100)*7}",bill)
             else:
                bill=bill=100*5+(unit-100)*7+(unit-200)*10
             print(F"Bill Amount :100*5={100*5+}100*7={(unit-100)*7},50*10{+(unit-200)*10}",bill)
        case 3:
            if bill>2000:
